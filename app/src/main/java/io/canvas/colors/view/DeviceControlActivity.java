...
import io.canvas.colors.SampleGattAttributes;
import io.canvas.colors.databinding.ActivityControlBinding;
...
public class DeviceControlActivity extends AppCompatActivity {
    ...
    private void clearUI() {
        ...
        binding.dataValue.setText("no data");
    }
    ...
    private void displayData(String data) {
        if (data != null) {
            binding.dataValue.setText(data);
        }
    }
